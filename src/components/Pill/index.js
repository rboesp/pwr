    ...
    render() {
        return (
            // <div className='badge rounded-pill badge-pill'>
                ...
                >{this.props.name}
                    <svg width="24" height="24" viewBox="0 0 256 272" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                        <g>
